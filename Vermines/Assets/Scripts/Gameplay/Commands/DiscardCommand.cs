    ...
    public class ADMIN_CheckDiscardCommand : ACommand {
        ...
        public override CommandResponse Execute()
        {
            ...
            if (_CurrentPhase != PhaseType.Action)
                return new CommandResponse(CommandStatus.Invalid, "Table_Discard_WrongPhase");
            ...
            if (!playerDeck.Hand.Contains(_Card))
                return new CommandResponse(CommandStatus.CriticalError, "Table_Discard_CardNotInHand", _Card.Data.Name);
