...
namespace Vermines.Gameplay.Cards.Effect {
    ...
    [CreateAssetMenu(fileName = "New Played & Discard Effect", menuName = "Vermines/Card System/Card/Effects/Play and Discard Effect.")]
    public class PlayDiscardedEffect : AEffect {

        #region Constants

        private static readonly string descriptionTemplate = "Play or discard the <b>{0}</b>";
        ...
        [SerializeField]
        private EffectType _Type = EffectType.Discard & EffectType.Play;
        ...
        public Sprite PlayThisCardIcon = null;
        ...
        private void OnEnable()
        {
            ...
            if (PlayThisCardIcon == null)
                PlayThisCardIcon = Resources.Load<Sprite>("Sprites/UI/Effects/Partisan_Card_Played");
