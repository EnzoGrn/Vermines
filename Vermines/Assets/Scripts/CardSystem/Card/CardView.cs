...
public class CardView : MonoBehaviour {
    ...
    public SpriteRenderer Background; // Background image from Sprites/Card/{Type}/Background.jpg
    public SpriteRenderer SplashArt;  // Character art image from Sprites/Card/{Type}/{Character}.png
    ...
    private void UpdateUI()
    {
        ...
        if (data.Sprite != null) {
            ...
            Transform oldTransform = SplashArt.GetComponent<Transform>();
